...
void ncModelLoader::Initialize( void ) {
    ...
    _core.Print( LOG_INFO, "Loading asset: models\n" );
...
/*
    Spawn model.
*/
void ncModelLoader::Spawn( modeltype_t type, const char *name, const char *shadername,
...
/*
    Render models.
*/
void ncModelLoader::Render( bool reflection, eye_t eye ) {
    int i;
    ...
    for( i = 0; i < _gameworld.spawned_models; i++ ) {
        ...
        ncVec3 reflectedView = ncVec3( 10.0f, -10.0f, 10.0f );
        ncVec3 defaultView = ncVec3( 10.0f, 10.0f, 10.0f );
